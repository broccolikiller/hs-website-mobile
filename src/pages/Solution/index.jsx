...
import campus1 from '../../assets/solution/campus1.png'
import campus2 from '../../assets/solution/campus2.png'
            ...
            <div className={'px-4 text-gray-700'}>
                {
                    ...
                    <div>
                        <div>
                            <h1 className={'text-xl font-bold text-center py-6'}>智慧互动校园整体解决方案</h1>
                            <div className={'flex justify-center'}>
                                <img className={'w-[28%]'} src={campus1} alt=""/>
                            </div>
                            ...
                            <div className={'flex justify-center'}>
                                <img className={'w-[28%]'} src={campus2} alt=""/>
                            </div>
                            <div className={'flex justify-center'}>
                                <img src={campus3} alt=""/>
                            </div>
